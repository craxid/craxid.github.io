        ...
        topRepos.forEach(repo => { // Loop hanya untuk repo teratas yang sudah diurutkan
            ...
            repoElement.innerHTML = `
                ...
                <div class="flex items-center text-sm text-gray-500 dark:text-gray-400 mb-3">
                    ...
                    <!-- Fork Icon -->
                    <svg class="w-4 h-4 ml-4 mr-1" fill="currentColor" viewBox="0 0 20 20"><path d="M10 18v-6h-2V6a2 2 0 012-2h2a2 2 0 012 2v6h-2v6m-4 0a2 2 0 01-2-2v-3m8 0a2 2 0 00-2-2v-3"></path></svg>
